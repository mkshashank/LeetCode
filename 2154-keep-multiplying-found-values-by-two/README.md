<h2><a href="https://leetcode.com/problems/keep-multiplying-found-values-by-two/?envType=problem-list-v2&envId=hash-table&difficulty=EASY">2154. Keep Multiplying Found Values by Two</a></h2><h3>Easy</h3><hr><p>You are given an array of integers <code>nums</code>. You are also given an integer <code>original</code> which is the first number that needs to be searched for in <code>nums</code>.</p>
